...
class APP {
  ...
  initBase() {
    ...
    _UISelectors__WEBPACK_IMPORTED_MODULE_0__["UISelectors"].searchInput.addEventListener('keyup', () => {
      ...
      _ui__WEBPACK_IMPORTED_MODULE_1__["UI"].getResults();
    });
