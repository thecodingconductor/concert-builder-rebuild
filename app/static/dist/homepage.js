...
if (_modules_UISelectors__WEBPACK_IMPORTED_MODULE_7__["UISelectors"].user !== null) {
  const currentUser = _modules_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"].getUser();
  window.addEventListener('DOMContentLoaded', _modules_ui__WEBPACK_IMPORTED_MODULE_6__["UI"].displayConcerts(currentUser))
}
