...
[..._modules_UISelectors__WEBPACK_IMPORTED_MODULE_7__["UISelectors"].createConcertBtns].forEach((btn) => {
  btn.addEventListener('click', _modules_ui__WEBPACK_IMPORTED_MODULE_6__["UI"].createConcertFunction);
});
